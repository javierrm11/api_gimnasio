...
const { User, Rutina, RutinaEjercicio, EstadisticasEjercicio, Ejercicio, DuracionEntrenamiento, Seguidores } = require("../models/association");
    ...
    try {
        const user = await User.findByPk(id, {
            include: [
            {
                ...
                {
                    model: User,
                    as: "seguido", // Cambiado de "seguidor" a "seguido"
            ...
            },
            {
                ...
                {
                    model: User,
                    as: "seguidor", // Cambiado de "seguido" a "seguidor"
                    attributes: ["id", "Nombre_Usuario", "Foto"]
                }
                ]
            }
